    ...
    return (
        <>
            <section className="section-benefit">
                ...
                <SectTagline name="WHY TWEETMAX WORKS SMARTER." />
                <span className="br-line"></span>
                <MainBenefitSection />
                <span className="br-line"></span>
                <SectBottom />
                    ...
                    <div className="place-video">
                        ...
                        <div className="sect-title wow fadeInUp">
                            <h2 className="s-title font-3">
                                Built for creators on 𝕏. <br />
                                Backed by always-on automation.
                            </h2>
                            <p className="s-sub_title">
                                TweetMax pairs scheduling, auto-replies, and auto-DMs in one workspace <br className="d-none d-lg-block" />— built for
                                speed, reach, and conversion.
                            </p>
                        </div>
                    </div>
