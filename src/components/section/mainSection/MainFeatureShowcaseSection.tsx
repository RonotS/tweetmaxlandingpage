...
// Section 3 main: feature tabs above, dashboard preview below.
export default function MainFeatureShowcaseSection() {
    const [activeTab, setActiveTab] = useState("tweetAutomations");
